[Filter](https://cs50.harvard.edu/college/2020/fall/psets/4/filter/less/#filter)
================================================================================
...
![a simple bitmap](https://cs50.harvard.edu/college/2020/fall/psets/4/filter/less/bitmap.png)
...
![red smile](https://cs50.harvard.edu/college/2020/fall/psets/4/filter/less/red_smile.png)
...
![a grid of pixels](https://cs50.harvard.edu/college/2020/fall/psets/4/filter/less/grid.png)
...
[![Filter Walkthrough](https://j.gifs.com/mq87R0.gif)](https://www.youtube.com/watch?v=K0v9byp9jd0&list=PLhQjrBD2T3837jmUt0ep7Tpmnxdv9NVut)
...
```
check50 cs50/problems/2020/fall/filter/less
```
...
1.  Download only your `helpers.c` file by control-clicking or right-clicking on the file in CS50 IDE's file browser and choosing Download. (You do not need to submit any other files, but be sure that you do submit a file called `helpers.c`).
2.  Go to CS50's [Gradescope page](https://www.gradescope.com/courses/157004).
3.  Click "Problem Set 4: Filter (Less)".
4.  Drag and drop your `helpers.c` file to the area that says "Drag & Drop". Be sure it has the correct filename!
5.  Click "Upload".

You should see a message that says "Problem Set 4: Filter (Less) submitted successfully!" You won't see a score just yet, but if you see the message then we've received your submission!
